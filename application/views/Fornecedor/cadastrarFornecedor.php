          ...
          <div class="row">
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
              <div class="card card-primary mt-5">
                ...
                <div class="card-body">
                  <form action="../fornecedor/FornecedorCadastrar" method="POST" enctype="multipart/form-data">


                    <div class="row">
                      <div class="form-group col-6">
                        <label for="fornecedor">Fornecedor</label>
                        <input id="fornecedor" type="text" class="form-control" name="fornecedor" autofocus>
                      </div>
                      <div class="form-group col-6">
